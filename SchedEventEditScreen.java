...
class SchedEventEditScreen extends JDialog implements ActionListener 
{
    ...
    public SchedUpdate            mParentDialog;

    // Dialog constructor.
    public SchedEventEditScreen(SchedUpdate  parentDialog,
    ...
    public void actionPerformed( ActionEvent e ) {
        if ( e.getActionCommand().equals("Exit") ) {
            ...
            mParentDialog.updateText(mReturnString);
            if (mScreenPopup.getPopupKey().equals("Y"))
                mParentDialog.updateValue(mValue);
